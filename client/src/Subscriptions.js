      ...
      <AuthCheck fallback={<SignIn />}>
        ...
        <div className="well">
          ...
          <button
            className={
              'btn ' +
              (plan === 'price_1HAKmpDhtTCl2mk06CEcyds5'
                ? 'btn-primary'
                : 'btn-outline-primary')
            }
            onClick={() => setPlan('price_1HAKmpDhtTCl2mk06CEcyds5')}>
            Choose Monthly $25/m
          </button>
          ...
          <button
            className={
              'btn ' +
              (plan === 'price_1HAKmpDhtTCl2mk06uH7ZjAR'
                ? 'btn-primary'
                : 'btn-outline-primary')
            }
            onClick={() => setPlan('price_1HAKmpDhtTCl2mk06uH7ZjAR')}>
